        ...
        <div className="mb-12">
          {user && (
            <div className="mb-6 animate-in fade-in slide-in-from-left duration-700">
              <span className="inline-block px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 text-[10px] font-black uppercase tracking-[0.2em] mb-3">
          ...
          <p className="text-orange-500 font-medium tracking-wider uppercase text-sm mb-3">Our Collection</p>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight">Today's <span className="text-orange-500">Menu</span></h1>
            ...
            {user?.role === 'vendor' && (
              <button
                ...
                className="flex items-center gap-2 px-6 py-3.5 bg-orange-500 hover:bg-orange-600 text-white rounded-2xl font-bold transition-all shadow-lg shadow-orange-500/20 active:scale-95 self-start md:self-center"
              >
        ...
        <div className="mb-12 space-y-6">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white/5 border border-white/10 rounded-2xl focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none text-white placeholder-gray-500 transition-all"
            />
          </div>
          <div className="flex space-x-3 overflow-x-auto pb-4 scrollbar-hide">
            {categories.map((category) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full font-semibold whitespace-nowrap transition-all duration-300 ${selectedCategory === category
